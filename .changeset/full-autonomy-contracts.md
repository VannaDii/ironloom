...
- OpenClaw Discord control handling for normalized requests and operator interaction callbacks, plus OpenClaw storage, memory, and telemetry tools that honor the whitespace-normalized `DEVPLAT_STORAGE_ROOT`
