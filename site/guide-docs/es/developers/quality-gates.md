...
- El probe externo del runtime usa el mismo fallback al gate predeterminado de la organización cuando SonarCloud devuelve `NONE`, por lo que los probes en vivo informan passed o failed en lugar de dejar el quality gate pendiente.
