...
- CI verifica el proyecto SonarCloud `vannadii_ironloom` antes del análisis, lo crea cuando SonarCloud devuelve 404 y alinea la rama principal de SonarCloud con la rama predeterminada de GitHub.
