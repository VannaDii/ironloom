...
- `@vannadii/devplat-execution`: current code covers structured subprocess execution, service-level repository-relative cwd refusal, timeouts, retryable exit-code policy, truncation policy, and retry outcome contracts.
