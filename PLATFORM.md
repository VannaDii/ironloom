...
- `@vannadii/devplat-supervisor`: current code covers next-step decisions, telemetry, lifecycle signals, blocker-aware route plans, phase routing across research, specs, slicing, implementation, gates, review, remediation, merge, continuation, and shared timestamp validation for supervisor decisions.
