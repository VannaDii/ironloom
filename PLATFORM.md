...
- `@vannadii/devplat-execution`: current code covers structured subprocess execution, service-level repository-relative cwd refusal, timeouts, retry policy, truncation policy, and retry outcome contracts.
